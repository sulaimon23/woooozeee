...
- https://github.com/creativetimofficial/woozeee-admin-dashboard/issues/18 (Added this in live docs, we need for our product to have a homepage prop inside the package.json. If build is not working, just delete the homepage prop from inside the package.json, or configure it to your own specs.)
- https://github.com/creativetimofficial/woozeee-admin-dashboard/issues/17
- https://github.com/creativetimofficial/woozeee-admin-dashboard/issues/15
- https://github.com/creativetimofficial/woozeee-admin-dashboard/issues/12
- https://github.com/creativetimofficial/woozeee-admin-dashboard/issues/3
